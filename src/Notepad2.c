...
BOOL      bNotepadReplaced;
BOOL      bCheckIfNotepadReplaced = TRUE;
BOOL      bShowToolbar;
BOOL      bShowStatusbar;
...
void MsgInitMenu(HWND hwnd,WPARAM wParam,LPARAM lParam)
{
  ...
  if (bCheckIfNotepadReplaced) {
    bNotepadReplaced = IsNotepadReplaced();
    bCheckIfNotepadReplaced = FALSE;
  }
  CheckCmd(hmenu,IDM_VIEW_REPLACENOTEPAD,bNotepadReplaced);
...
LRESULT MsgCommand(HWND hwnd,WPARAM wParam,LPARAM lParam)
{
  ...
  switch(LOWORD(wParam))
  {
    ...
    case IDM_VIEW_REPLACENOTEPAD:
      ToggleNotepadReplace(!bNotepadReplaced, hwnd);
      bCheckIfNotepadReplaced = TRUE;
      break;
